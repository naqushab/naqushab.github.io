...
var staticPages = map[string]Document{
	"assets/pages/index.html": {
		Description: "Naqushab Neyazee is a Software Development Engineer.",
	},
	...
	"assets/pages/about.html": {
		Title:       "About",
		Description: "Experience and skillset of Naqushab Neyazee, a Software Development Engineer.",
	},
	"assets/pages/contact.html": {
		Title:       "Contact",
		Description: "Ways to get in contact with Naqushab Neyazee - through email or social media.",
	},
}
